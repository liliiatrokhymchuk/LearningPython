...
print(
    mylist2[0:1]
)  # slice. The first integer is the index where the slice starts. The second integer is the index where the slice ends.
...
print(
    len(mylist3)
)  # length return the number of values that are in a list value passed to it
