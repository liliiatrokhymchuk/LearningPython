...
s5 = pd.Series(d, index=["Name1", "Test", "Name3", "Name4", "Test1"]) #here there is no value corresponding to new names in our dictionary d(result for Test is NaN)
print(s5)
...
#list
students_list = [["Name1", "Lastname1", 23, "Chemistry", 86],
...
#dictionary
students_dictionary = {"First_Name":["Name1", "Name2", "Name3", "Name4"],
